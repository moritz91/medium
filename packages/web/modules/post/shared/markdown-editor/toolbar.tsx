import { CommandButton } from "modules/post/shared/markdown-editor/command-button";
import { CommandContainer, NavTab } from "modules/post/shared/markdown-editor/styles";
...
export const Toolbar: React.FC<ToolbarProps> = React.memo(({ tab, isIE8, onCommand, handleTabChange }) => (
  <div className="editor-header">
    ...
    <nav className="editor-header-tabs">
      <NavTab type="button" className={`${tab === "write" ? "selected" : ""}`} onClick={() => handleTabChange("write")}>
        Write
      </NavTab>
      <NavTab
        type="button"
